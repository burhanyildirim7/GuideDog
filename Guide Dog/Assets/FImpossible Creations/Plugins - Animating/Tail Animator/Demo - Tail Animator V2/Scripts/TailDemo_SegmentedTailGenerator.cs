...
public class TailDemo_SegmentedTailGenerator : MonoBehaviour
{
    ...
    public  void Start()
    {
        ...
        if (TailWithSettings)
        {
            ...
            /*İlk iki objeyi görünmez yapıyorum*/     
            //tailSegments[0].gameObject.transform.GetComponent<MeshRenderer>().enabled = false;
            //tailSegments[0].gameObject.transform.GetChild(0).gameObject.SetActive(false);
            //tailSegments[0].gameObject.transform.GetComponent<BoxCollider>().enabled = false;
            //tailSegments[0].gameObject.transform.GetChild(1).GetComponent<MeshRenderer>().enabled = false;
            //tailSegments[0].gameObject.transform.GetChild(1).GetComponent<BoxCollider>().enabled = false;
            ////tailSegments[0].gameObject.transform.GetChild(1).GetChild(0).gameObject.SetActive(false);
        ...
        else
        {
            ...
            //tailSegments[0].gameObject.transform.GetComponent<MeshRenderer>().enabled = false;
            //tailSegments[0].gameObject.transform.GetComponent<BoxCollider>().enabled = false;
            //tailSegments[0].gameObject.transform.GetChild(0).GetComponent<MeshRenderer>().enabled = false;
            //tailSegments[0].gameObject.transform.GetChild(0).GetComponent<BoxCollider>().enabled = false;
        }
        ...
        if (cutSegment.transform)
        {
            ...
            if (cutSegment.transform.childCount > 0)
                if (AddTailAnimToCuttedSegment)
                {
                    ...
                    rig.AddForce(new Vector3(5f, 1f, 0f), ForceMode.Impulse);
            ...
            else // Adding new segments
            {
                ...
                for (int i = 0; i < toAdd; i++)
                {
                    ...
                    if (Cuttable)
                    {
                        ...
                        cutId.owner = this;
                        /*Boxcollider eklenmişti sadece. Ben true ilave ettim. */
                        segment.AddComponent<BoxCollider>().isTrigger=true;
